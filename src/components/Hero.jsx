...
const Hero = () => {
    return (
        <div id='hero' className="relative h-auto w-full bg-cover bg-center bg-no-repeat py-20 gap-10 md:gap-5 px-5 md:px-28  md:py-18 flex flex-col md:flex-row justify-around items-center" style={{ backgroundImage: `url(${Img2})` }}>
